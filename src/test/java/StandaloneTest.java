...
public class StandaloneTest {
    ...
    void setUp() throws ExecutionException, InterruptedException {
        ...
        connectRunner = new ConnectRunner(Paths.get("data/kafka-connect-arangodb/kafka-connect-arangodb-1.0.7.jar"), BOOTSTRAP_SERVERS_CONFIG);
        connectRunner.start();
    }
    ...
    @Test
    @Timeout(30)
    void testBasicDeliveryStandalone() throws ExecutionException, InterruptedException {
        ...
        assertThat(connectRunner.connectorState(CONNECTOR_NAME).connector().state()).isEqualTo("RUNNING");
